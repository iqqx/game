...
export class GUISpotLight extends GUIBase {
    ...
    Render() {
        for (const dot of this._dots)
            GUI.DrawCircleWithGradient(dot.Position.X, dot.Position.Y, 1000, new Color(255, 255, 255, 25 * Math.sin(dot.lifeTime / 3000)), Color.Transparent);
    }
}
