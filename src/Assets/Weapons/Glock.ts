...
export class Glock extends Weapon {
	private static readonly _icon = LoadImage("Images/Glock-icon.png");
	private static readonly _image = LoadImage("Images/Player/Pistol.png", new Rectangle(0, 3, 32, 28), 0.75);
