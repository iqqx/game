...
const scene = new Scene(new Player(), LoadImage("Images/Level_demo.png"));

scene.Instantiate(new Wall(500, 80, 25, 100));
scene.Instantiate(new Wall(700, 30, 150, 10));
...
scene.Instantiate(new Human(1000, 500, EnemyType.Green));
